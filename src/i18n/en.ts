export const en = {
  ...
  reactions: {
    title: 'Reactions',
    placeholder: 'Say something about this episode…',
    post: 'Post reaction',
  },
  detail: {
  ...
  profile: {
    ...
    share_hint: 'Scan the code or share the link to open your profile.',
  ...
  settings: {
    ...
    avatar_hint: 'JPG or PNG. You’ll frame it next.',
    avatar_too_big: 'That image is too large (max 15 MB).',
    avatar_error: 'Couldn’t upload the photo. Try again.',
    crop_title: 'Frame your photo',
    crop_hint: 'Drag to move · pinch or use the slider to zoom',
    crop_zoom: 'Zoom',
    crop_apply: 'Use photo',
    preset_cta: 'Pick a character',
    preset_title: 'Choose an avatar',
    preset_hint: 'Iconic faces from film & TV — tap one to use it.',
    save: 'Save',
    saved: 'Saved',
    password: 'Password',
